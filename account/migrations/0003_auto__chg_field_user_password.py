...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'account_user', 'password', self.gf('django.db.models.fields.CharField')(default='123', max_length=200))

    def backwards(self, orm):

        # Changing field 'User.password'
        db.alter_column(u'account_user', 'password', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
