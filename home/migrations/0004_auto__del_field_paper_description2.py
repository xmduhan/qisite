...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Paper.description2'
        db.delete_column(u'home_paper', 'description2')


    def backwards(self, orm):
        # Adding field 'Paper.description2'
        db.add_column(u'home_paper', 'description2',
                      self.gf('django.db.models.fields.CharField')(default='111', max_length=1000),
                      keep_default=False)
