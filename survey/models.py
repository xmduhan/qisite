...
class Sample(models.Model):
    ...
    #targetCust = models.ForeignKey('TargetCust', verbose_name='清单项')
    targetCust = models.OneToOneField('TargetCust', verbose_name='清单项')
    user = models.ForeignKey(account.models.User, verbose_name="用户")  # 这里是否设置一个related_name
...
class TargetCust(models.Model):
    ...
    #自定信息	defineInfo	对象集
    #sample = models.ForeignKey('Sample', verbose_name='样本') 在样本中已设定了一对一关系
...
class Branch(models.Model):
    ...
    ord = models.IntegerField('排序号')
    nextQuestion = models.ForeignKey('Question', verbose_name='下个问题')
