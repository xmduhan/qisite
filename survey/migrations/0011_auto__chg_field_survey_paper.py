...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Survey.paper'
        db.alter_column(u'survey_survey', 'paper_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Paper'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Survey.paper'
        raise RuntimeError("Cannot reverse this migration. 'Survey.paper' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Survey.paper'
        db.alter_column(u'survey_survey', 'paper_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Paper']))
    ...
    models = {
        ...
        u'survey.survey': {
            ...
            'modifyTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'paper': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Paper']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
