...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Survey.custList'
        db.add_column(u'survey_survey', 'custList',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['survey.CustList'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Survey.custList'
        db.delete_column(u'survey_survey', 'custList_id')
