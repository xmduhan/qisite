...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Survey.anonymous'
        db.add_column(u'survey_survey', 'anonymous',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Survey.pay'
        db.add_column(u'survey_survey', 'pay',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Survey.anonymous'
        db.delete_column(u'survey_survey', 'anonymous')

        # Deleting field 'Survey.pay'
        db.delete_column(u'survey_survey', 'pay')
