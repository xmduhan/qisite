...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sample.nextQuestion'
        db.add_column(u'survey_sample', 'nextQuestion',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Sample.nextQuestion'
        db.delete_column(u'survey_sample', 'nextQuestion_id')
