...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Survey.lastSmsSendTime'
        db.add_column(u'survey_survey', 'lastSmsSendTime',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Survey.lastSmsSendTime'
        db.delete_column(u'survey_survey', 'lastSmsSendTime')
    ...
    models = {
        ...
        u'survey.survey': {
            ...
            'endTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 13, 0, 0)'}),
