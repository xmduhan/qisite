...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustList.descrition'
        db.alter_column(u'survey_custlist', 'descrition', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'CustList.descrition'
        db.alter_column(u'survey_custlist', 'descrition', self.gf('django.db.models.fields.CharField')(default=None, max_length=200))
    ...
    models = {
        ...
        u'survey.custlist': {
            ...
            'createTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'descrition': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'survey.survey': {
            ...
            'createTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'endTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 23, 0, 0)'}),
