...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Paper.survey'
        db.add_column(u'survey_paper', 'survey',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='paperReversed_set', null=True, to=orm['survey.Survey']),
                      keep_default=False)

        # Adding field 'Survey.paused'
        db.add_column(u'survey_survey', 'paused',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Paper.survey'
        db.delete_column(u'survey_paper', 'survey_id')

        # Deleting field 'Survey.paused'
        db.delete_column(u'survey_survey', 'paused')
    ...
    models = {
        ...
        u'survey.survey': {
            ...
            'createTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'endTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 18, 0, 0)'}),
