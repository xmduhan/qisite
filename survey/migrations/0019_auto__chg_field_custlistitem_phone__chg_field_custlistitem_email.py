...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustListItem.phone'
        db.alter_column(u'survey_custlistitem', 'phone', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'CustListItem.email'
        db.alter_column(u'survey_custlistitem', 'email', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'CustListItem.phone'
        db.alter_column(u'survey_custlistitem', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'CustListItem.email'
        db.alter_column(u'survey_custlistitem', 'email', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
    ...
    models = {
        ...
        u'survey.survey': {
            ...
            'createTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'endTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 24, 0, 0)'}),
