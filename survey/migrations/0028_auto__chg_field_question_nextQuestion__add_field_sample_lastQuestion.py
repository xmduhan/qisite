...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.nextQuestion'
        db.alter_column(u'survey_question', 'nextQuestion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Question'], null=True, on_delete=models.SET_NULL))
        # Adding field 'Sample.lastQuestion'
        db.add_column(u'survey_sample', 'lastQuestion',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Question'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Question.nextQuestion'
        db.alter_column(u'survey_question', 'nextQuestion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Question'], null=True))
        # Deleting field 'Sample.lastQuestion'
        db.delete_column(u'survey_sample', 'lastQuestion_id')
    ...
    models = {
        ...
        u'survey.sample': {
            ...
            'lastQuestion': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Question']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
        ...
        u'survey.survey': {
            ...
            'endTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 6, 0, 0)'}),
