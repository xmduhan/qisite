...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SampleItem.createBy'
        db.alter_column(u'survey_sampleitem', 'createBy_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.User']))

        # Changing field 'SampleItem.modifyBy'
        db.alter_column(u'survey_sampleitem', 'modifyBy_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.User']))

    def backwards(self, orm):

        # Changing field 'SampleItem.createBy'
        db.alter_column(u'survey_sampleitem', 'createBy_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['account.User']))

        # Changing field 'SampleItem.modifyBy'
        db.alter_column(u'survey_sampleitem', 'modifyBy_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['account.User']))
    ...
    models = {
        ...
        u'survey.sample': {
            ...
            'isValid': ('django.db.models.fields.BooleanField', [], {}),
        ...
        u'survey.survey': {
            ...
            'createTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'endTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 21, 0, 0)'}),
