...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Paper.style'
        db.delete_column(u'survey_paper', 'style')


    def backwards(self, orm):
        # Adding field 'Paper.style'
        db.add_column(u'survey_paper', 'style',
    ...
    models = {
        ...
        u'survey.survey': {
            ...
            'createTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 1, 0, 0)'}),
            'endTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 1, 0, 0)'}),
            ...
            'publishTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 1, 0, 0)'}),
