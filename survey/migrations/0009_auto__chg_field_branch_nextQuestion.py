...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Branch.nextQuestion'
        db.alter_column(u'survey_branch', 'nextQuestion_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['survey.Question']))

    def backwards(self, orm):

        # Changing field 'Branch.nextQuestion'
        db.alter_column(u'survey_branch', 'nextQuestion_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['survey.Question']))
