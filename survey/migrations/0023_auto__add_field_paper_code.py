...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Paper.code'
        db.add_column(u'survey_paper', 'code',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Paper.code'
        db.delete_column(u'survey_paper', 'code')
    ...
    models = {
        ...
        u'survey.survey': {
            ...
            'endTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 1, 0, 0)'}),
