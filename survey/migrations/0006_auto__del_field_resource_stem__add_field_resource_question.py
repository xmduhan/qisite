...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Resource.stem'
        db.delete_column(u'survey_resource', 'stem_id')

        # Adding field 'Resource.question'
        db.add_column(u'survey_resource', 'question',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['survey.Question']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Resource.stem'
        db.add_column(u'survey_resource', 'stem',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['survey.Question']),
                      keep_default=False)

        # Deleting field 'Resource.question'
        db.delete_column(u'survey_resource', 'question_id')
