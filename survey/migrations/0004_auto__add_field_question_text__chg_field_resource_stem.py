...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'survey_question', 'text',
                      self.gf('django.db.models.fields.CharField')(default='123', max_length=300),
                      keep_default=False)


        # Changing field 'Resource.stem'
        db.alter_column(u'survey_resource', 'stem_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Question']))

    def backwards(self, orm):
        # Deleting field 'Question.text'
        db.delete_column(u'survey_question', 'text')


        # Changing field 'Resource.stem'
        db.alter_column(u'survey_resource', 'stem_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Stem']))
    ...
    models = {
        ...
        u'survey.resource': {
            ...
            'stem': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Question']"}),
