...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Survey.passwd'
        db.delete_column(u'survey_survey', 'passwd')

        # Adding field 'Survey.password'
        db.add_column(u'survey_survey', 'password',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Survey.passwd'
        db.add_column(u'survey_survey', 'passwd',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Deleting field 'Survey.password'
        db.delete_column(u'survey_survey', 'password')
