...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sample.session'
        db.add_column(u'survey_sample', 'session',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sample.session'
        db.delete_column(u'survey_sample', 'session')
    ...
    models = {
        ...
        u'survey.survey': {
            ...
            'endTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 21, 0, 0)'}),
