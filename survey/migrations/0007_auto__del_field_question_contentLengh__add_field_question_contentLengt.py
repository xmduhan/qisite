...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Question.contentLengh'
        db.delete_column(u'survey_question', 'contentLengh')

        # Adding field 'Question.contentLength'
        db.add_column(u'survey_question', 'contentLength',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Question.contentLengh'
        db.add_column(u'survey_question', 'contentLengh',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Question.contentLength'
        db.delete_column(u'survey_question', 'contentLength')
