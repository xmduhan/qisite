...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Sample', fields ['targetCust']
        db.delete_unique(u'survey_sample', ['targetCust_id'])


        # Changing field 'Sample.targetCust'
        db.alter_column(u'survey_sample', 'targetCust_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.TargetCust'], null=True))

    def backwards(self, orm):

        # Changing field 'Sample.targetCust'
        db.alter_column(u'survey_sample', 'targetCust_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['survey.TargetCust'], unique=True, null=True))
        # Adding unique constraint on 'Sample', fields ['targetCust']
        db.create_unique(u'survey_sample', ['targetCust_id'])
    ...
    models = {
        ...
        u'survey.survey': {
            ...
            'endTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 31, 0, 0)'}),
